...
function DraggableComponent({ component }: DraggableComponentProps) {
  ...
  return (
    <div
      ...
      {...attributes}
      className={cn(
        "flex items-center space-x-3 rounded-lg border border-gray-200 bg-white p-3 shadow-sm transition-all hover:border-gray-300 hover:shadow-md cursor-grab active:cursor-grabbing",
